# CampusCloud — Demo Credentials & Bulk Data

> Generated: 2026-04-30 | Re-run: `python3 /tmp/seed_campuscloud.py`
> Seed script is at `/tmp/seed_campuscloud.py` (copy to `scripts/seed_demo.py` to persist).
...
| School | Students | Teachers | Classes | Sections | Plan |
|--------|----------|----------|---------|----------|------|
| Sunrise Academy | 15 | 6 | 5 | 10 | BASIC |
| Greenwood High | 15 | 6 | 5 | 10 | BASIC |
| Riverdale Public | 15 | 6 | 5 | 10 | BASIC |
| Oakridge International | 15 | 6 | 5 | 10 | BASIC |
| **Total** | **60** | **24** | **20** | **40** | |

> Students with login accounts: first 5 per school (10 total across unique usernames since usernames are shared per-tenant schema).
