package com.cloudcampus.common.security;
...
public class OwnershipChecker {
    ...
    public boolean canViewStudentData(Authentication auth, UUID studentId) {
        ...
        if (!(auth.getPrincipal() instanceof CloudCampusUserDetails caller)) {
            return false;
        }
     ...
     */
    public Optional<Set<UUID>> resolveAllowedStudentIds(CloudCampusUserDetails caller) {
